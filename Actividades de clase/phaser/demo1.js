...
function update() {
    ...
    if( modoAuto==true && bala2.position.y > 100){
        const result = datosDeEntrenamiento([despBala2,jugador.position.x,bala2.position.x]) 
    ...
    if( modoAuto ==false  && bala2.position.y > 100  && despBala2>0){
        ...
        console.log('input',despBala2,bala2.body.position.x)
